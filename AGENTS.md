...
Handled by the `release-notes` agent (`~/.claude/agents/release-notes.md`).
Project-specific parameters (core dependency, tag scheme quirks, pre-vetted
non-applicable advisories) live in `.claude/release-notes.yml`.
